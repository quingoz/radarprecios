...
class Roles extends Controllers{
    public function __construct()
    {
        ...
        // Obtiene permisos para el módulo 3 (Roles)
        getPermisos(3);
    }
    ...
    public function getRoles()
    {
        ...
        if($_SESSION['permisosMod']['r']){
            ...
            // Procesa cada rol para agregar botones y formato
            for ($i=0; $i < count($arrData); $i++) {
                ...
                // Verifica permisos para mostrar botones
                ...
                // Agrega los botones a los datos del rol
    ...
    {
        // Genera opciones para un select HTML con roles activos
        $htmlOptions = "";
        $arrData = $this->model->selectRoles();
        if(count($arrData) > 0 ){
            for ($i=0; $i < count($arrData); $i++) { 
    ...
    public function setRol(){
        ...
        // Determina si es creación (idRol = 0) o actualización
        if($intIdrol == 0)
        {
            // Creación - verifica permisos de escritura
            if($_SESSION['permisosMod']['w']){
                $request_rol = $this->model->insertRol($strRol, $strDescipcion,$intStatus);
                $option = 1;
            }
        }else{
            // Actualización - verifica permisos de actualización
            if($_SESSION['permisosMod']['u']){
